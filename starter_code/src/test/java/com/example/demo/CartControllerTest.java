...
public class CartControllerTest {
    ...
    @Before
    public void setup(){
        when(userRepository.findByUsername("joselara1234")).thenReturn(createUser());
    ...
    public void TestAddToCart(){
        ...
        request.setItemId(1);
        request.setUsername("joselara1234");
        ...
        assertEquals("joselara1234", actualCart.getUser().getUsername());
