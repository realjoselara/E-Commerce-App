...
public class JWTAuthenticationVerificationProvider extends BasicAuthenticationFilter {
    public JWTAuthenticationVerificationProvider(AuthenticationManager authManager) {
        super(authManager);
    }
